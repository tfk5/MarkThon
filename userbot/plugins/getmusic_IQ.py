...
#                           STRINGS                           #
# =========================================================== #
SONG_SEARCH_STRING = "<code>MK..! I am finding your song....</code>"
SONG_NOT_FOUND = "<code>Sorry !I am unable to find any song like that</code>"
SONG_SENDING_STRING = "<code>yeah..! i found something MK..🥰...</code>"
...
async def _(event):
    ...
    catevent = await edit_or_reply(event, "`MK..! I am finding your song....`")
    ...
    await catevent.edit("`yeah..! i found something MK..🥰`")
...
async def _(event):
    ...
    if event.pattern_match.group(1):
        ...
        return
    cat = base64.b64decode("QUFBQUFGRV9vWjVYVE5fUnVaaEtOdw==")
    catevent = await edit_or_reply(event, "`Please wait..! I am finding your song....`")
    video_link = await yt_search(str(query))
    if not url(video_link):
        return await catevent.edit(
            f"Sorry!. I can't find any related video/audio for `{query}`"
